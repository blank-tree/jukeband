...
function draw() {
  ...
  for (var contentIterator = 0; contentIterator < 4; contentIterator++) {
  	placeContent(completeContent[contentIterator], contentIterator);
  }
...
function placeContent(weekContent, weekNo) {
	...
	var kuratorText = [];
	var kuratorTextX = 14;
	var kuratorTextY0 = b.round(b.random(0,5));
	var kuratorTextHeight0 = b.round(b.random(4,6));
	var kuratorTextY1 = b.round(b.random(0,5));
	var kuratorTextHeight1 = b.round(b.random(4,6));

	kuratorText[0] = b.text(weekContent.kuratorDescription, gridX[kuratorTextX] - b.width, gridY[kuratorTextY0], commentBlockWidth * gridWidth - gridGap, kuratorTextHeight0 * gridHeight - gridGap);
	kuratorText[1] = b.text(weekContent.kuratorDescription, gridX[kuratorTextX + commentBlockWidth] - b.width, gridY[kuratorTextY1], commentBlockWidth * gridWidth - gridGap, kuratorTextHeight1 * gridHeight - gridGap);

	placeKuratorDesc(weekNo, weekContent.kuratorName);
...
function placeImageIndexDesc() {
	...
	descFrames[0] = b.text("JANUARY", gridX[12] - b.width - gridGap, gridY[12] - gridGap, gridHeight, gridGap);
	descFrames[1] = b.text("2017", gridX[12] - b.width - gridGap, gridY[11] - gridGap, gridHeight, gridGap);
	descFrames[2] = b.text("WORLDWIDE", gridX[12] - b.width - gridGap, gridY[9] - gridGap, gridHeight, gridGap);
	descFrames[3] = b.text("2:31:28", gridX[12] - b.width - gridGap, gridY[8] - gridGap, gridHeight, gridGap);

	b.popMatrix();
}

function placeKuratorDesc(weekNo, kuratorName) {
	b.pushMatrix();
	...
	descFrames[0] = b.text("JANUARY", gridX[12] - b.width - gridGap, gridY[12] - gridGap, gridHeight, gridGap);
	descFrames[1] = b.text("2017", gridX[12] - b.width - gridGap, gridY[11] - gridGap, gridHeight, gridGap);
	descFrames[2] = b.text("WEEK " + weekNo, gridX[12] - b.width - gridGap, gridY[9] - gridGap, gridHeight, gridGap);
	descFrames[3] = b.text(kuratorName, gridX[12] - b.width - gridGap, gridY[8] - gridGap, gridHeight * 2, gridGap);
