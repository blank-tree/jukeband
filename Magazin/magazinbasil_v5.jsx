...
var gridY = [0, 73.228, 146.457, 219.685, 292.913, 366.142, 439.37, 512.598, 585.827, 659.055, 732.283, 805.512];
...
function placeImageIndex(completeContent) {
	...
	for (var imgIteratorY = 0; imgIteratorY < 4; imgIteratorY++) {
		for (var imgIteratorX = 0; imgIteratorX < 7; imgIteratorX++) {
			...
			var currentImg = b.image(imgPath, gridX[imgIteratorX * 3 + xJump] - b.width + xJumpGap, gridY[imgIteratorY * 2 + 1], imgSize, imgSize);		
...
function placeIndexDesc() {
	...
	descFrames[0] = b.text("JANUARY", gridX[12] - b.width - gridGap, gridY[11] - gridGap, gridHeight, gridGap);
	descFrames[1] = b.text("2017", gridX[12] - b.width - gridGap, gridY[10] - gridGap, gridHeight, gridGap);
	descFrames[2] = b.text("2:31:28", gridX[12] - b.width - gridGap, gridY[7] - gridGap, gridHeight, gridGap);

	descFrames[3] = b.text("JANUARY", gridX[11] - b.width - gridGap, gridY[11] - gridGap, gridHeight, gridGap);
	descFrames[4] = b.text("2017", gridX[11] - b.width - gridGap, gridY[10] - gridGap, gridHeight, gridGap);
	descFrames[5] = b.text("WORLDWIDE", gridX[11] - b.width - gridGap, gridY[8] - gridGap, gridHeight, gridGap);
